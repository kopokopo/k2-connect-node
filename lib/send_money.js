...
function SendMoneyService(options) {
   ...
   * @param {object} opts
   * @param {string} opts.type - The source type (e.g. merchant_wallet, merchant_bank_account, mobile_wallet, bank_account, till, paybill).
    ...
    return new Promise(function (resolve, reject) {
      ...
      try {
        ...
        if (Array.isArray(opts.destinations)) {
          // include source_identifier only when destinations are provided (i.e. not my_accounts)
          reqBody.source_identifier = typeof opts.sourceIdentifier !== 'undefined' ? opts.sourceIdentifier : null;
