...
function Webhooks(options) {
	...
	*/
	 ...
	 * @param {boolean} [opts.enableDarajaPayload] - Whether to include the daraja payload. Only valid for buygoods_transaction_received and b2b_transaction_received event types.
	...
	this.subscribe = function (opts) {
		return new Promise(function (resolve, reject) {
			...
			var reqBody = {
				...
				'enable_daraja_payload': opts.enableDarajaPayload
			}
