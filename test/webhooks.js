  ...
  describe("subscribe()", function () {
    ...
    describe("subscribe() validation", function () {
      ...
      it("#subscribe() must have eventType", function () {
        ...
        return webhooks
          ...
          .should.be.rejectedWith(Error, {
            message: "Event type can't be blank; ",
          });
      });
      ...
      it("#subscribe() must have url", function () {
        ...
        return webhooks
          .subscribe(opts)
          .should.be.rejectedWith(Error, { message: "Url can't be blank; " });
      });
      ...
      it("#subscribe() must have scope", function () {
        ...
        return webhooks
          .subscribe(opts)
          .should.be.rejectedWith(Error, { message: "Scope can't be blank; " });
      });
          ...
          var req = mocks.createRequest({
            ...
            headers: {
              ...
              "X-KopoKopo-Signature":
                "2003545dc9b861a76613aeaee238a6acf57ef61d9ff06c6dcab16f43bea0198b",
            },
        ...
        it("#webhookHandler() b2b received succeeds", () => {
          var req = mocks.createRequest({
            ...
            headers: {
              "Content-Type": "application/json",
              "X-KopoKopo-Signature":
                "b6a29eb7407d0d5bd3221950e333017389ebb2c25f1ae95b5a5f802691b03378",
            },
          ...
          return webhooks.webhookHandler(req, res).then((response) => {
            expect(response.event.type).to.equal(
              "External Till to Till Transaction",
            );
          });
        });
        ...
        it("#webhookHandler() merchant_to_merchant received succeeds", () => {
          var req = mocks.createRequest({
            ...
            headers: {
              "Content-Type": "application/json",
              "X-KopoKopo-Signature":
                "6cec8b268163aba8921886e2b36318034d7722d1437a739c2c9ae733638db14e",
            },
      ...
      it("#webhookHandler() buygoods_transaction_reversed succeeds", () => {
        var req = mocks.createRequest({
          ...
          headers: {
            "Content-Type": "application/json",
            "X-KopoKopo-Signature":
              "037996afb710ae4013fca55d3b6fbcdd709061b889682a21ecfc7f7202955c75",
          },
      ...
      it("#webhookHandler() settlement_transfer_completed succeeds", () => {
        var req = mocks.createRequest({
          ...
          headers: {
            "Content-Type": "application/json",
            "X-KopoKopo-Signature":
              "80e0ede7a59f8be54f1dec966428decdb78e1e5a7a565e719a428d48f992404e",
          },
      ...
      it("#webhookHandler() customer_created succeeds", () => {
        var req = mocks.createRequest({
          ...
          headers: {
            "Content-Type": "application/json",
            "X-KopoKopo-Signature":
              "e519084b3af1086a9d08cfe4665a5f72a3cb67784bb6b3b92435b9b32e7d9e02",
          },
        ...
        it("#webhookHandler() stk successful result succeeds", () => {
          var req = mocks.createRequest({
            ...
            headers: {
              "Content-Type": "application/json",
              "X-KopoKopo-Signature":
                "c8170d057ee80180874293c89642cfbc6eebec6a433ca750e0d66b21384ddc21",
            },
        ...
        it("#webhookHandler() stk unsuccessful result succeeds", () => {
          var req = mocks.createRequest({
            ...
            headers: {
              "Content-Type": "application/json",
              "X-KopoKopo-Signature":
                "6da68de7312c14f04497febefddb84eed8baac380e43d79103c52cbb76f59d5b",
            },
        ...
        it("#webhookHandler() pay result succeeds", () => {
          var req = mocks.createRequest({
            ...
            headers: {
              "Content-Type": "application/json",
              "X-KopoKopo-Signature":
                "031588aacd0fa175049a28c08cc3e6a55e2f251cc3d69a40b3b34b14e23ed1c1",
            },
            body: payresult,
          });
          var res = mocks.createResponse();
        ...
        it("#webhookHandler() transfer result succeeds", () => {
          var req = mocks.createRequest({
            ...
            headers: {
              "Content-Type": "application/json",
              "X-KopoKopo-Signature":
                "a74c11c8783a159961d39a6ec5331ac1ffe4530c32544c5fe64ed1ceb8746cee",
            },
            body: transferresult,
          });
          var res = mocks.createResponse();
